...
-- Volcando datos para la tabla bd_usuarios.tbrol_docente: ~3 rows (aproximadamente)
...
INSERT INTO `tbusuario_alumno` (`idusuario`, `fk_dnialumno`, `contraalumno`, `estado`) VALUES
	(1, 71349066, '123', b'1'),
	(2, 71345543, '542', b'1'),
	(3, 71635321, '764', b'1'),
	(4, 71092341, '923', b'1');
...
CREATE TABLE IF NOT EXISTS `tbusuario_docente` (
  `idusuariodoc` int(11) NOT NULL AUTO_INCREMENT,
...
-- Volcando datos para la tabla bd_usuarios.tbusuario_docente: ~3 rows (aproximadamente)
INSERT INTO `tbusuario_docente` (`idusuariodoc`, `fk_dnidocente`, `contradocente`, `estado`) VALUES
	(1, 72631234, '198', b'1'),
	(2, 16234231, 'luis123', b'1'),
	(3, 12625478, 'miguel12', b'1');
